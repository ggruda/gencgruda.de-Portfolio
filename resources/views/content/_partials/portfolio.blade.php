...
<section id="portfolio" class="section portfolio">
    <div class="container">
        <div class="heading-meta-container">
            ...
            <h6 class="description">Einige meiner Projekte</h6>
        </div>

        <div class="row">
            <div class="col-md-12">
                <h3>Wird demnächst befüllt ...</h3>
                Demnächst werde ich hier einige meiner Projekte verlinken, sodass du dir einen besseren Überblick über meine Arbeiten machen kannst.
            </div>
        </div>
{{--        <div class="row">--}}
{{--            <!--   Portfolio Filters   -->--}}
